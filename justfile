...
test-idb-firefox: build-idb-driver
    cd harness && mise exec -- sh -c 'toolchain="$(dirname "$(rustup which rustc)")"; export PATH="$toolchain:$PATH" RUSTC="$toolchain/rustc" CARGO="$toolchain/cargo" WASM_BINDGEN_TEST_TIMEOUT=120; wasm-pack test --headless --firefox --test idb_spike && wasm-pack test --headless --firefox --test idb_store --features idb-vendor-spike && wasm-pack test --headless --firefox --test idb_vfs --features idb-vendor-spike && wasm-pack test --headless --firefox --test idb_crash --features idb-vendor-spike && wasm-pack test --headless --firefox --test idb_receipt --features idb-vendor-spike && wasm-pack test --headless --firefox --test idb_cross_worker --features idb-vendor-spike && wasm-pack test --headless --firefox --test idb_cross_tab --features idb-vendor-spike'

test-idb-chrome: check-chrome-driver build-idb-driver
    cd harness && mise exec -- sh -c 'toolchain="$(dirname "$(rustup which rustc)")"; export PATH="$toolchain:$PATH" RUSTC="$toolchain/rustc" CARGO="$toolchain/cargo" WASM_BINDGEN_TEST_TIMEOUT=120; wasm-pack test --headless --chrome --chromedriver "{{justfile_directory()}}/.tools/chromedriver" --test idb_spike && wasm-pack test --headless --chrome --chromedriver "{{justfile_directory()}}/.tools/chromedriver" --test idb_store --features idb-vendor-spike && wasm-pack test --headless --chrome --chromedriver "{{justfile_directory()}}/.tools/chromedriver" --test idb_vfs --features idb-vendor-spike && wasm-pack test --headless --chrome --chromedriver "{{justfile_directory()}}/.tools/chromedriver" --test idb_crash --features idb-vendor-spike && wasm-pack test --headless --chrome --chromedriver "{{justfile_directory()}}/.tools/chromedriver" --test idb_receipt --features idb-vendor-spike && wasm-pack test --headless --chrome --chromedriver "{{justfile_directory()}}/.tools/chromedriver" --test idb_cross_worker --features idb-vendor-spike && wasm-pack test --headless --chrome --chromedriver "{{justfile_directory()}}/.tools/chromedriver" --test idb_cross_tab --features idb-vendor-spike'
