...
| `idb_vfs` | 7 | Opt-in local PageDB `IdbVfs` workflows: sync, rename while open, metadata visibility, reopen, vectored read, modes, remove, direct listing, truncate, real transaction aborts, and locks in Firefox; it is not a selectable fallback |
